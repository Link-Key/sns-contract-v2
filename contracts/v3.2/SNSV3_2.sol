...
contract SNSV3_2 is NFTV2 , ISns{
            ...
            if(nameLength == 3){
                ...
                if(!isOutOfferEndingTime){
                    if(_freeShortMint[minter_]){
                        ...
                        if(_shortNameAllowedlist[minter_]){
                            priceOfShort = PriceOfShort({
                ...
                priceInfo.maticPrice = _invite.getInviteDiscountPrice(priceOfShort.maticPrice, inviter_);
                priceInfo.keyPrice = 2**256 - 1;
                priceInfo.lowbPrice = 2**256 - 1;
                priceInfo.usdcPrice = 2**256 - 1;
            }else{
